...
## Aim
This analysis describes the seroprevalence of SARS-CoV-2 and associated risk factors in a cohort of residents in Pau da Lima, an urban slum of Salvador, Brazil. The provided code replicates the analyses featured in Fofana et al, using a deidentified dataset.  
...
```
- Overall: `r round(serov$est * 100, 2)` [95% CI `r round(serov$conf.int[1] * 100, 2)` - `r round(serov$conf.int[1] * 100, 2)`]

- Children (<18y): `r round(serch$est * 100, 2)` [95% CI `r round(serch$conf.int[1] * 100, 2)` - `r round(serch$conf.int[1] * 100, 2)`]

- Adults: `r round(serad$est * 100, 2)` [95% CI `r round(serad$conf.int[1] * 100, 2)` - `r round(serad$conf.int[1] * 100, 2)`]

- Male participants: `r round(serm$est * 100, 2)` [95% CI `r round(serm$conf.int[1] * 100, 2)` - `r round(serm$conf.int[1] * 100, 2)`]

- Female participants: `r round(serf$est * 100, 2)` [95% CI `r round(serf$conf.int[1] * 100, 2)` - `r round(serf$conf.int[1] * 100, 2)`]  
...
- Seroprevalence among adults living with children: `r round(sercy$est * 100, 2)`% [95% CI `r round(sercy$conf.int[1] * 100, 2)` - `r round(sercy$conf.int[1] * 100, 2)`%]
- Seroprevalence among adults without children in their household: `r round(sercn$est * 100, 2)`% [95% CI `r round(sercn$conf.int[1] * 100, 2)` - `r round(sercn$conf.int[1] * 100, 2)`%]


- Seroprevalence among children living with 1 adult: `r round(sera1$est * 100, 2)`% [95% CI `r round(sera1$conf.int[1] * 100, 2)` - `r round(sera1$conf.int[1] * 100, 2)`%]
- Seroprevalence among children living with 2 adults: `r round(sera2$est * 100, 2)`% [95% CI `r round(sera2$conf.int[1] * 100, 2)` - `r round(sera2$conf.int[1] * 100, 2)`%]  
...
- Frequency of symptoms among seropositive individuals: `r round(sxigp$est * 100, 2)`% [95% CI `r round(sxigp$conf.int[1] * 100, 2)` - `r round(sxigp$conf.int[1] * 100, 2)` %]

- Frequency of symptoms among seronegative individuals: `r round(sxign$est * 100, 2)`% [95% CI `r round(sxign$conf.int[1] * 100, 2)` - `r round(sxign$conf.int[1] * 100, 2)` %]

- Difference: `r round(abs(sxdif$est[1] - sxdif$est[2])* 100, 2)`% [95% CI `r round(sxdif$conf.int[1] * 100, 2)` - `r round(sxdif$conf.int[1] * 100, 2)` %]  
...
```
- Unemployment among women: `r round(unempf$est * 100, 2)`% [95% CI `r round(unempf$conf.int[1] * 100, 2)` - `r round(unempf$conf.int[1] * 100, 2)`%]

- Unemployment among men: `r round(unempm$est * 100, 2)`% [95% CI `r round(unempm$conf.int[1] * 100, 2)` - `r round(unempm$conf.int[1] * 100, 2)`%]  
...
p2c <- ggplot(data = dat3, aes(x = covidser3, y = hsize, 
  ...
  theme_classic() +
  stat_pvalue_manual(stat.test2c, hide.ns=T, label = "p.adj.signif", 
