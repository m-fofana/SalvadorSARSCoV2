...
p2a + p2b + plot_layout(widths = unit(c(7, 7), c('cm', 'cm')), heights = unit(6, "cm"))
```
...
p2c + p2d + plot_layout(widths = unit(c(7, 7), c('cm', 'cm')), heights = unit(6, "cm"))

p2e + plot_layout(widths = unit(c(10), c('cm')), heights = unit(8, "cm"))
...
p3a + p3b + plot_layout(widths = unit(c(8, 8), c('cm', 'cm')), heights = unit(5, "cm"))
```
